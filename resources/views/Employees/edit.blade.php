            ...
            <div class="card" style="height: 882.281px;">
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        ...
                        <form class="form" method="POST" action="{{url('employee/'.$employee->id)}}" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="form-body">
                             ...
                             <div class="row">
                                 <div class="col-md-6">
                                     <div class="form-group">
                                         ...
                                         <input value="{{$employee->first_name}}" type="text" id="firstName" class="form-control" placeholder="Name" name="firstName" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Name" data-original-title="" title="">
                                     </div>
                                     @error('firstName')
                                 ...
                                 <div class="col-md-6">
                                     <div class="form-group">
                                         ...
                                         <input value="{{$employee->last_name}}" type="text" id="lastName" class="form-control" placeholder="Name" name="lastName" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Name" data-original-title="" title="">
                                     </div>
                                     @error('lastName')
                                     <div class="alert alert-danger">{{ $message }}</div>
                                     @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="companyId" name="companyId" class="form-control" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Accessory Type" data-original-title="" title="">
                                        ...
                                        @foreach($companies as $list)
                                            <option {{$employee->company_id==$list->id?'selected':''}} value="{{$list->id}}">{{$list->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                @error('companyId')
                              ...
                              <div class="row">
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          <input value="{{$employee->email}}" type="email" id="email" class="form-control" placeholder="email" name="email" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="email" data-original-title="" title="">
                                      </div>
                                      @error('email')
                                      <div class="alert alert-danger">{{ $message }}</div>
                                      @enderror
                                  ...
                                  <div class="col-md-6">
                                      <div class="form-group">
                                          ...
                                          <input value="{{$employee->phone}}" type="number" id="phone" class="form-control" placeholder="email" name="phone" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="email" data-original-title="" title="">
                                      </div>
                                      @error('phone')
                                      <div class="alert alert-danger">{{ $message }}</div>
                                      @enderror
