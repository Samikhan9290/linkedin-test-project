                        ...
                        <form class="form" method="POST" action="{{route('company.store')}}" enctype="multipart/form-data">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" class="form-control" placeholder="Name" name="name" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Name" data-original-title="" title="">
                                </div>
                                @error('name')
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-md-6">
                                      <div>
                                          <img width="100px" height="100px" id="blah" src="" alt="your image" />
                                      </div>
                                  </div>
                              </div>
